...
function animateGradient() { //Responsible for animating the gradient
    ...
    const colors = [
    //     `radial-gradient(at ${30 + 50 * Math.sin(angle * Math.PI / 180)}% ${50 + 25 * Math.cos(angle * Math.PI / 180)}%, rgb(51, 204, 204) 0px, transparent 40%)`, //cyan,
    ...
    //     `radial-gradient(at ${30 + 25 * Math.sin((angle + 15) * Math.PI / 180)}% ${50 + 25 * Math.cos((angle + 15) * Math.PI / 180)}%, rgb(222, 81, 251) 0px, transparent 60%)`, //purple,
    //     `radial-gradient(at ${50 + 25 * Math.sin((angle + 42) * Math.PI / 90)}% ${50 + 25 * Math.cos((angle + -42) * Math.PI / 80)}%, rgb(0, 0, 255) 0px, transparent 60%)`, //blue,
    ...
    //     `radial-gradient(at ${60 + 25 * Math.sin((angle + 57) * Math.PI / 180)}% ${50 + 25 * Math.cos((angle + -57) * Math.PI / 180)}%, rgb(200, 50, 66) 0px, #9600ff 60%)`,//red,
    // ];
